...
export const ADM_SUCCESS_MESSAGE = 'ADM_SUCCESS_MESSAGE'
export const ADM_ERROR_MESSAGE = 'ADM_ERROR_MESSAGE'
export const ADM_CLOSE_MESSAGE = 'ADM_CLOSE_MESSAGE'
export const ADM_INFO_MESSAGE = 'ADM_INFO_MESSAGE'